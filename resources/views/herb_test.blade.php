...
@section('content')
    ...
    <div class="QA-box">
        ...
        <div class="radio-space">
            <!-- required:入力必須-->
            <input id="radio1" type="radio" name="question" required><label for="radio1" class="radio-label"><span id="choice_1" style="font-size: 20px; padding-left: 10px;">選択肢1</span></label><br>
            <input id="radio2" type="radio" name="question" required><label for="radio2" class="radio-label"><span id="choice_2" style="font-size: 20px; padding-left: 10px;">選択肢2</span></label><br>
            <div class="next-btn">
            ...
            if(radio1.checked){
                switch(num){
                    ...
                    case 6:
                        ...
                        num = 0;
                        cnt = 0;
                        window.location.href='/test/herb/result/1';
                        break;
                    case 7:
                        /* 質問8から診断結果3へ */
                        num = 0;
                        cnt = 0;
                        window.location.href='/test/herb/result/3';
                        break;
                    case 8:
                        /* 質問9から診断結果2へ */
                        num = 0;
                        cnt = 0;
                        window.location.href='/test/herb/result/2';
                        break;
                }
            /* 選択肢2の場合 */
                ...
                switch(num){
                    ...
                    case 8:
                        ...
                        num = 0;
                        cnt = 0;
                        window.location.href='/test/herb/result/4';
                        break;
                }
            }
        }
